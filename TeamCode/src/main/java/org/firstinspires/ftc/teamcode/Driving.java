...
//        }
//        if (sideOfTurn)
//            a.setMotorPower(new double[][]{{power, -power}, {power, -power}});
//        else
//            auto1.setMotorPower(new double[][]{{-power, power}, {-power, power}});
//        if (directTurn)
...
//
//
//        auto.setMotorPower(driveMotors, new double[][]{{0, 0}, {0, 0}});
//    }
//
//
//
